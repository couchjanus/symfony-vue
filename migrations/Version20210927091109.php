 ...
 */
final class Version20210927091109 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE admin (id INT IDENTITY NOT NULL, email NVARCHAR(180) NOT NULL, roles VARCHAR(MAX) NOT NULL, password NVARCHAR(255) NOT NULL, PRIMARY KEY (id))');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_880E0D76E7927C74 ON admin (email) WHERE email IS NOT NULL');
        $this->addSql('EXEC sp_addextendedproperty N\'MS_Description\', N\'(DC2Type:json)\', N\'SCHEMA\', \'dbo\', N\'TABLE\', \'admin\', N\'COLUMN\', roles');
        ...
        $this->addSql('CREATE TABLE product (id INT IDENTITY NOT NULL, brand_id INT NOT NULL, category_id INT NOT NULL, name NVARCHAR(255) NOT NULL, image_name NVARCHAR(255) NOT NULL, updated_at DATETIME2(6) NOT NULL, created_at DATETIME2(6) NOT NULL, slug NVARCHAR(128) NOT NULL, description VARCHAR(MAX) NOT NULL, price DOUBLE PRECISION NOT NULL, stock_quantity INT NOT NULL, PRIMARY KEY (id))');
